...
public class NoticePageInfo {
	...
	public NoticePageInfo(int currentPage, int totalCount, int recordCountPerPage, int naviCountPerPage,
	...
	public String toString() {
		return "NoticePageInfo [currentPage=" + currentPage + ", totalCount=" + totalCount + ", recordCountPerPage="
