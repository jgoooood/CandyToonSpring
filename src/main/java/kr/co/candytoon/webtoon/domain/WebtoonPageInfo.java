...
public class WebtoonPageInfo {
	...
	public WebtoonPageInfo() {
		super();
	}

	public WebtoonPageInfo(int currentPage, int totalCount, int recordCountPerPage, int naviCountPerPage,
	...
	public String toString() {
		return "WebtoonPageInfo [currentPage=" + currentPage + ", totalCount=" + totalCount + ", recordCountPerPage="
